    ...
    $('#toursDataTable').DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                "sortable": false,
                "render": function (data, type, full, meta) {
                    var deleteBtn = '<button class="btnDeleteTour btn btn-circle btn-sm bg-danger text-gray-100" data-id="' + full.Id + '" data-name="' + full.Name + '"><i class="far fa-trash-alt"></i></button>';
                    return deleteBtn;
                }
            }
        ],
